      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
          {pillSkills.map((skill) => (
            <div
              key={skill.name}
              className="flex items-center gap-2.5 px-5 py-2.5 rounded-full border border-border bg-secondary/50 text-sm text-foreground hover:border-primary/50 transition-colors"
            >
